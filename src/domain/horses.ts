...
const BROODMARE_STATUS_OVERRIDES: Pick<
  BroodmareProfile,
  "name" | "speedRank" | "staminaRank" | "surface"
>[] = [
  { name: "シャトーブランシュ", speedRank: "A", staminaRank: "A", surface: "turf" },
  { name: "ヤンキーローズ", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "サザンスターズ", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "ロカ", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "チェッキーノ", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "パルティトゥーラ", speedRank: "B", staminaRank: "A", surface: "turf" },
  { name: "トップデサイル", speedRank: "B", staminaRank: "B", surface: "versatile" },
  { name: "エアルーティーン", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "オートクレール", speedRank: "B", staminaRank: "A", surface: "turf" },
  { name: "コーステッド", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "インナーアージ", speedRank: "B", staminaRank: "A", surface: "turf" },
  { name: "サンブルエミューズ", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "ルミナスパレード", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "アスコルティ", speedRank: "A", staminaRank: "C", surface: "turf" },
  { name: "インディアマントゥアナ", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "ブチコ", speedRank: "A", staminaRank: "C", surface: "versatile" },
  { name: "デアリングバード", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "フォエヴァーダーリング", speedRank: "A", staminaRank: "B", surface: "dirt" },
  { name: "アムールポエジー", speedRank: "B", staminaRank: "B", surface: "dirt" },
  { name: "ネフェルティティ", speedRank: "B", staminaRank: "B", surface: "dirt" },
  { name: "チェストケローズ", speedRank: "A", staminaRank: "B", surface: "dirt" },
  { name: "クイーンパイレーツ", speedRank: "B", staminaRank: "B", surface: "dirt" },
  { name: "エミーズプライド", speedRank: "B", staminaRank: "B", surface: "dirt" },
  { name: "マルケッサ", speedRank: "B", staminaRank: "B", surface: "versatile" },
  { name: "サイマー", speedRank: "B", staminaRank: "B", surface: "versatile" },
  { name: "エッジースタイル", speedRank: "B", staminaRank: "A", surface: "turf" },
  { name: "ブルークランズ", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "ロッテンマイヤー", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "ミュージアムヒル", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "シロインジャー", speedRank: "A", staminaRank: "C", surface: "turf" },
  { name: "Together Forever", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "Rhododendron", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "Modern Ideals", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "Modern Eagle", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "Rosaline", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "Folk Melody", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "Missy Moo", speedRank: "A", staminaRank: "C", surface: "turf" },
  { name: "Lilahjay", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "Berimbau", speedRank: "A", staminaRank: "C", surface: "turf" },
  { name: "Puca", speedRank: "A", staminaRank: "B", surface: "dirt" },
  { name: "Heavenly Love", speedRank: "B", staminaRank: "B", surface: "dirt" },
  { name: "Nonna Bella", speedRank: "A", staminaRank: "B", surface: "dirt" },
  { name: "Queen Caroline", speedRank: "A", staminaRank: "B", surface: "versatile" },
  { name: "Sataves", speedRank: "B", staminaRank: "B", surface: "dirt" },
  { name: "Mopotism", speedRank: "A", staminaRank: "B", surface: "dirt" },
  { name: "Ma’am", speedRank: "B", staminaRank: "B", surface: "dirt" },
  { name: "Too Precious", speedRank: "A", staminaRank: "B", surface: "turf" },
  { name: "Queen Blossom", speedRank: "A", staminaRank: "B", surface: "turf" },
];
